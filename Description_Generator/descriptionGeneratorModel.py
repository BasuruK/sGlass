...
def DscGenModel(max_token_length, vocabulary_size, num_image_features=2048,
        hidden_size=512, embedding_size=512, regularizer=0.01):

    # Embed captions into common embedding model
    text_input = Input(shape=(max_token_length, vocabulary_size), name='text_input')
